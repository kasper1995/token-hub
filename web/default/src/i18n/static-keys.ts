...
export const STATIC_I18N_KEYS = [
  ...
  'Review collected conversation sessions.',
  'Review collected conversation sessions and inspect raw request and response details.',
  ...
  'Only the latest 200 records are shown for this session.',
  'Search user or assistant text...',
  'Session ID',
  'All export states',
  'Unexported',
  'Exported',
