...
func InitOptionMap() {
	...
	common.OptionMap["ConversationLogDisabledGroups"] = setting.ConversationLogDisabledGroups2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "ConversationLogDisabledGroups":
		err = setting.UpdateConversationLogDisabledGroupsByJSONString(value)
